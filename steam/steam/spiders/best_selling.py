...
class BestSellingSpider(scrapy.Spider):
    ...
    start_urls = ['https://store.steampowered.com/search/?sort_by=_ASC&filter=topsellers/']
    ...
    def parse(self, response):
        ...
        for game in games:
            ...
            loader.add_xpath("discounted_rate", ".//div[contains(@class, 'col search_discount responsive_secondrow')]/span/text()")
